 ...
 * @public
 */
export function getUniversalResolver(url = 'https://resolver.ixo.world/1.0/identifiers/'): DIDResolver {
	if (!url) {
 ...
 */
export function getUniversalResolverFor(methods: string[], url = 'https://resolver.ixo.world/1.0/identifiers/'): Record<string, DIDResolver> {
